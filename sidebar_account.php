       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          <a href="#">
            ...
            <li class="active"><a href="<?php echo $path;?>/dash_account.php"><i class="fa fa-circle-o"></i> Home</a></li>
        ...
        <a href="#">
           ...
           <ul class="treeview-menu">
            ...
            <li><a href="<?php echo $path;?>/porder/porder.php"><i class="fa fa-circle-o"></i>Purchases/Stockin </a></li>
            ...
            <li><a href="<?php echo $path;?>/store_issue/invoice.php"><i class="fa fa-circle-o"></i>Store Issue</a></li>
            ...
            <li><a href="<?php echo $path;?>/payments/expenses.php"><i class="fa fa-circle-o"></i>Expenditure</a></li>
        ...
        <a href="#">
           ...
           <ul class="treeview-menu">
            <li><a href="<?php echo $path;?>/porder/porder.php"><i class="fa fa-circle-o"></i>Purchases/Stockin </a></li>
            <li><a href="<?php echo $path;?>//production/produce.php"><i class="fa fa-circle-o"></i>Production </a></li>
            <li><a href="<?php echo $path;?>//reports/stockmove.php"><i class="fa fa-circle-o"></i>Stock Movement </a></li>
            <li><a href="<?php echo $path;?>//reports/stocklist.php"><i class="fa fa-circle-o"></i>Stock Report</a></li>
            <li><a href="<?php echo $path;?>/store_issue/invoice.php"><i class="fa fa-circle-o"></i>Store Issue</a></li>
            <li><a href="<?php echo $path;?>/store_issue/search_stock.php"><i class="fa fa-circle-o"></i>Store Maintenance</a></li>
            
            <li><a href="<?php echo $path;?>//vendor/index.php"><i class="fa fa-circle-o"></i>Vendor/Supplier</a></li>
          </ul>
        </li>
