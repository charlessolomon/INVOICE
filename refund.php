...
<center><div style="background-color:#CCC" padding:1px>
	<div align="center"><img src="../dist/logo.png" width="65" height="65" /></div>
...
<?php		
			...
			//$result=mysqli_query($conn,"SELECT * FROM Recvno WHERE mdate>=2018/2/20 AND <=2018/2/21");
					...
					$result=mysqli_query($conn,"SELECT * FROM refundz");
...
<table cellspacing="0" style="width: 900px" align="center" id="example" class="table table-striped table-hover table-responsive">
