...
<!-- Left side column. contains the logo and sidebar -->
       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          <a href="#">
            ...
            <li class="active"><a href="<?php echo $path;?>/dash_outdoor.php"><i class="fa fa-circle-o"></i> Home</a></li>
 ...
 <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i><span>Cashier 2</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo $path;?>/invoice2/invoice.php"><i class="fa fa-circle-o"></i> Invoicing</a></li>
