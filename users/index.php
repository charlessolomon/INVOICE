...
<body>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">User Login registration.</h2><hr />
        ...
        $stmt = $db_con->prepare("SELECT * FROM users ORDER BY emp_id DESC");
        $stmt->execute();
    ...
    <div class="container">
        ...
        <a href="http://www.codingcage.com/2015/12/simple-jquery-insert-update-delete-with.html" target="_blank">Kontec 2019</a>
        </div>
